...
def _power_iteration_singular_values(
    mats: jnp.ndarray,    # (n_freq, Cout, Cin), real or complex
    iters: int
) -> jnp.ndarray:
...
class SpectralNorm(eqx.Module):
    ...
    def __init__(
        ...
        *,
        ...
        elif isinstance(layer, (SpectralCirculantLayer2d, AdaptiveSpectralCirculantLayer2d)):
        ...
        elif isinstance(layer, (SpectralDense, AdaptiveSpectralDense,
                                SpectralConv2d, AdaptiveSpectralConv2d)):
