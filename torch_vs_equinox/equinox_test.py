...
def train_equinox(model, state, opt_state, optimizer, loss_fn,
...
if __name__ == "__main__":
    ...
    final_metric = eval_equinox(inference_model, best_state, loss_fn, X_val, y_val, batch_size, eval_key, log_loss)
