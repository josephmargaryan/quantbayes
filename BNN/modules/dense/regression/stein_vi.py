...
class DenseRegressionSteinVI(BaseTask, BaseInference):
    """
...
if __name__ == "__main__":
    ...
    ############# Example Usage #############
    from BNN2.modules.dense.regression.stein_vi import DenseRegressionSteinVI
    ...
    key = jr.key(0)
    regressor = DenseRegressionSteinVI(num_steps=100, model_type="deep")
