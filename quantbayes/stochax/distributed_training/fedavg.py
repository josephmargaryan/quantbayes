        ...
        for rnd in range(1, self.outer_rounds + 1):
            ...
            for i in range(self.n_nodes):
                ...
                lm_trained, ls_trained, tr_hist, va_hist = eqx_train(
                    ...
                    X_shards[i],
                    y_shards[i],
                    X_shards[i],  # reuse shard for validation
                    y_shards[i],
            ...
            # keep first client's state as global
