        ...
        *,
        ...
        for w_i, s_i, k_i in zip(self.w_list, self.state_list, keys):
            ...
            if logits.shape[-1] == 1:
                ...
                # multiclass: (batch, n_classes)
                p = jax.nn.softmax(logits, axis=-1)
            all_probs.append(p)

        probs = jnp.stack(all_probs, axis=0)  # (n_nodes, batch, …)
...
if __name__ == "__main__":
    # Simple test for augmented trainer
    import numpy as onp
