...
The old layer-surgery utilities that rewrote models into spectral CNNs at load
 time have been removed from the public package surface. The recommended path is
now:
