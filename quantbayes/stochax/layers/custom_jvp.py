...
class SpectralPool2d(Module):
    """Two‑dimensional spectral pooling: FFT→crop→IFFT back to real."""

    output_size: tuple[int, int] = field(static=True)
    ...
    def __call__(self, x: Array, *, key: PRNGKeyArray | None = None) -> Array:
        ...
        x_pooled = jnp.fft.ifftn(Xc, axes=(-2, -1)).real
