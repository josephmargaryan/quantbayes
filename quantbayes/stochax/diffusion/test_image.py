...
from quantbayes.stochax.diffusion.dataloaders import generate_synthetic_image_dataset, dataloader
...
def test_unet_diffusion():
    ...
    advanced_unet = UNet(
        ...
        dropout_rate=0.1,
        num_res_blocks=2,
        attn_resolutions=[14, 7],       # Apply attention when the resolution matches these numbers
        key=model_key,
    )
