...
class RegressionModel:
    ...
    def visualize(
        ...
        plt.scatter(
            sorted_x[:, feature_index], sorted_y, label="Ground Truth", alpha=0.7
        )
        plt.scatter(
            sorted_x[:, feature_index], sorted_preds, label="Predictions", alpha=0.7
        )
...
if __name__ == "__main__":
    ...
    trainer.visualize(
        X_test, Y_test, preds, feature_index=0, title="Simple Regression Demo"
    )
