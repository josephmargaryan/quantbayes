...
from quantbayes.stochax.wrapper.wrapper_zoom import (
    EQXRegressorZoom,
...
# (define RegressorNN, BinaryNN, MulticlassNN exactly as above…)
...
def test_multiclass():
    ...
    models = {
        "log": LogisticRegression(solver="lbfgs", max_iter=500),
        "tree": DecisionTreeClassifier(max_depth=5),
        "eqx": EQXMulticlassClassifierZoom(
