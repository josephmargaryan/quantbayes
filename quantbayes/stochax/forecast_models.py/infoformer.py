...
class TransformerBlock(eqx.Module):
    ...
    def __init__(self, 
        ...
        self.mlp = SimpleMLP(in_features=embed_dim, hidden_features=hidden_mlp, dropout_p=dropout_p, key=key_mlp)
...
class InfoFormer(eqx.Module):
    ...
    def __init__(self,
        ...
        self.layers = [InfoFormerBlock(embed_dim, num_heads, mlp_ratio, dropout_p, bottleneck_dim, key=k)
                       for k in keys[:-1]]
...
class InfoFormerForecast(eqx.Module):
    ...
    def __init__(self,
                 ...
                 *,
                 key):
        self.model = InfoFormer(num_layers, embed_dim, num_heads, mlp_ratio, dropout_p, bottleneck_dim, key=key)
...
if __name__ == '__main__':
    ...
    model = InfoFormerForecast(num_layers=3, embed_dim=D, num_heads=4, dropout_p=0.1, bottleneck_dim=D//2, key=model_key)
