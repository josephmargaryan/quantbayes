...
from .direct_poisson import (
    ...
    compute_ball_sgd_hidden_mixture_rero_report,
...
def _normalize_rero_mode(mode: str) -> str:
    ...
    mapping = {
        ...
        "ball_sgd_hidden": "ball_sgd_hidden",
        "hidden": "ball_sgd_hidden",
        "hidden_mix": "ball_sgd_hidden",
        "unknown_inclusion": "ball_sgd_hidden",
        "unknown_inclusion_fdp": "ball_sgd_hidden",
    ...
    try:
        ...
        raise ValueError(
            "mode must be one of {'auto', 'dp', 'rdp', 'gaussian_direct', "
            "'ball_sgd_direct', 'ball_sgd_mix_comp', 'ball_sgd_hidden', "
            "'ball_sgd_hayes', 'ball_sgd_kaissis'}."
        ) from exc
...
def compute_ball_rero_report(
    ...
    *,
    ...
    if mode == "dp":
        ...
        _save_rero_report(report, out_path)
        return report
    elif mode == "ball_sgd_hidden":
        report = compute_ball_sgd_hidden_mixture_rero_report(
            release,
            prior,
            eta_grid=eta_grid,
        )
