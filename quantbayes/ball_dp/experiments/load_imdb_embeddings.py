...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Compute/cache canonical-split IMDb text embeddings and save JAX-ready arrays."
    )
...
def main() -> None:
    ...
    X_train, y_train, X_test, y_test = load_or_create_imdb_text_embeddings(
