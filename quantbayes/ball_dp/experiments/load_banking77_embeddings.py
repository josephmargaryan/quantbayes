...
DEFAULT_DATASET_ID = "PolyAI/banking77"
...
def default_output_path(
    ...
    return default_cache_dir(output_root) / f"banking77_{model_slug}_embeddings.npz"


def load_or_create_banking77_text_embeddings(
    batch_size: int = 128,
    ...
    return load_or_create_text_classification_embeddings(
        ...
        train_desc="BANKING77 train",
        test_desc="BANKING77 test",
    )


def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Compute/cache canonical-split BANKING77 text embeddings and save JAX-ready arrays."
    )
...
def main() -> None:
    ...
    X_train, y_train, X_test, y_test = load_or_create_banking77_text_embeddings(
