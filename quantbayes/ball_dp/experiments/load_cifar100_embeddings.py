...
def default_output_path(data_root: str = "./data") -> Path:
    return default_cache_dir(data_root) / "cifar100_resnet18_embeddings.npz"
...
def load_or_create_cifar100_resnet18_embeddings(
    data_root: str = "./data",
    batch_size: int = 128,
    num_workers: int = 4,
    require_jax_gpu: bool = True,
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description=(
            "Compute/cache canonical-split CIFAR-100 embeddings with pretrained ResNet18 "
    ...
    parser.add_argument(
        ...
        type=str,
        default=None,
        help="Optional .npz output path. Default: ./data/embeddings/cifar100_resnet18_embeddings.npz",
    )
    parser.add_argument(
        "--force-recompute",
        action="store_true",
...
def main() -> None:
    ...
    X_train, y_train, X_test, y_test = load_or_create_cifar100_resnet18_embeddings(
