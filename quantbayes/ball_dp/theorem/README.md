...
The theorem-facing part of the library should now be treated as:

```
quantbayes/ball_dp/
├── __init__.py                 # lightweight lazy imports
├── README.md                   # this file
├── theorem/
│   ├── __init__.py
│   ├── specs.py
...
│   ├── checkpointing.py
│   └── README.md
└── nonconvex/models/...        # existing theorem implementations
```

The point is not to delete the older theorem modules immediately; it is to stop asking users to discover the API by opening standalone scripts.
