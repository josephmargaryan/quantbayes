...
def build_feature_extractor(torch_device: torch.device):
    ...
    model.fc = torch.nn.Identity()  # output shape: [B, 512]
    model.eval()
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Extract canonical-split CIFAR-10 embeddings with pretrained ResNet18 and return/save JAX arrays."
    )
