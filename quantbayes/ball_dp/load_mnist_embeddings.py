...
# Important when mixing PyTorch + JAX on one GPU in one process.
...
def load_mnist_resnet18_embeddings(
    ...
    # Free PyTorch GPU state before moving data into JAX.
    del model
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Extract canonical-split MNIST embeddings with pretrained ResNet18 and return/save JAX arrays."
    )
