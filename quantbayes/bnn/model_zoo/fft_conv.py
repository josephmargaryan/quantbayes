...
class FFTConv1DModel:
    ...
    def __init__(
        self, in_channels=1, out_channels=8, kernel_size=16, name="fft_conv1d_model"
    ):
        ...
        self.fft_conv1d = FFTConv1d(
            in_channels, out_channels, kernel_size, name=f"{name}_fftconv"
        )
