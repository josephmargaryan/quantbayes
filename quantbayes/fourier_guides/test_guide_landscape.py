...
from quantbayes.fourier_guides.guides import SpectralImagGuide, SpectralRealGuide, SpectralRealCirculantGuide, SpectralImagCirculantGuide
...
if use_custom_guides:
    ...
    K_value = 9
    spectral_real_guide = SpectralRealCirculantGuide(model, K=K_value)
    spectral_imag_guide = SpectralImagCirculantGuide(model, K=K_value)
