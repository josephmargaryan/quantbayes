...
def generate_images(diffusion: GaussianDiffusion, shape=(8, 3, 64, 64), device='cuda', show=True):
    """
...
def generate_time_series(diffusion: GaussianDiffusion, shape=(8, 100, 1), device='cuda'):
    """
...
def generate_tabular_samples(diffusion: GaussianDiffusion, shape=(8, 16), device='cuda'):
    """
