...
class FFTBinarySteinVI(BaseTask, BaseInference):
    """
    Bayesian Binary Classification Model with FFT-based Circulant Matrix Layer using Stein Variational Inference.
    """
...
if __name__ == "__main__":
    ...
    ############# Example Usage #############
    from BNN2.modules.fft.binary_classification.stein_vi import FFTBinarySteinVI
    ...
    key = jr.key(0)
    classifier = FFTBinarySteinVI(num_particles=10, model_type="deep", num_steps=100)
