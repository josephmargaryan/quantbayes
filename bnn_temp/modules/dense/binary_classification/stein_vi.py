...
class DenseBinaryiSteinVI(BaseTask, BaseInference):
    """
...
if __name__ == "__main__":
    ...
    ############# Example Usage #############
    from bnn.modules.dense.binary_classification.stein_vi import DenseBinaryiSteinVI
    ...
    key = jr.key(0)
    classifier = DenseBinaryiSteinVI(
