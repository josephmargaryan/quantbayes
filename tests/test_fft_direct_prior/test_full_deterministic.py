...
class DeterministicNet(eqx.Module):
    ...
    def __init__(self, in_features: int, out_features: int, *, key):
        ...
        self.fft_layer = FFTDirectPriorLinear(in_features=in_features, key=key1, init_scale=1.0)
        self.linear = eqx.nn.Linear(in_features=in_features, out_features=out_features, key=key2)
