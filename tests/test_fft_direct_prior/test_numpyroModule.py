...
from quantbayes.stochax.utils import get_fft_full_for_given_params, plot_fft_spectrum, visualize_circulant_kernel
...
class MyBayesNetFFTDirect(bnn.Module):
    ...
    def __call__(self, X, y=None):
        ...
        fft_layer = bnn.FFTDirectPriorLinear(in_features=in_features, name="fft_direct_1")
        hidden = fft_layer(X)
